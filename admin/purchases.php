...
// All purchases
$purchases = $pdo->query("SELECT * FROM v_purchase_details ORDER BY purchased_at DESC")->fetchAll();
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-muted small"><?= date('d M Y, h:i A', strtotime($p['purchased_at'])) ?></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
                </tbody>
